...
var info_dict = {
	...
	"titleM" : "The Magic",
	"M1" : "I can perform magic by clicking and holding the mouse and tracing LARGE patterns",
	...
	"M4" : "There's a symbol to unlock objects hidden behind the safe in the office upstairs, locked behind a temporal lock.",
	...
	"A3" : "If I click on the flower pot hook for 4 seconds, a computer terminal comes down.",
	...
	"B2" : "There's a notebook in this room, it looks like someone went crazy in here. Looks like they opened their computer by CLICKING ON THE FLOWER POT FOR AT LEAST 4 SECONDS. I wonder if I can do something similar…",
	"B3" : "There's a pattern drawn in blood in this room.. What can it mean? I should inspect CLOSER",
	"titleD" : "The Office",
	"D1" : "It looks like the office door is locked soon after the start of the shift. If only I could have gotten there early enough.. Well thats a task for the next person.",
	...
	"D5b" : "By using the time spell, I can open the safe! There is a symbol there, I should inspect CLOSER",
